...
class Pop_Up:
    ...
    def new_pop_up(self,x,y,life_span=0.3,text=''):
    ...
    def new_red_frame(self,x,y,life_span=0.3):
        self.red_frame = pyglet.sprite.Sprite(pyglet.image.load('resc/red_frame.png'),x,y)
        self.life_time = life_span
