...
cards = {
            ...
            'Schwertkaempfer': [1,500,500,300,4,1,'resc\jolas\Schwertkaempfer.png',[Card.RegenStamina],'',[]],
            'Turm': [1,6000,6000,400,7,0,'resc/jolas/turm.png',[Card.generate_mana],'immovable',[]],
            'Paladin': [1,3000,3000,200,7,1,'resc\jolas\Palatin.png',[Card.RegenStamina],'',[]],
            ...
            'Speerkaempfer': [1,400,400,400,4,1,'resc\jolas\Speerwerfer.png',[Card.RegenStamina],'',[]],
            'Heiler': [1,700,700,135,10,1,'resc\jolas\Healer.png',[Card.heal,Card.RegenStamina],'',[]],
            'Orc': [1,700,800,500,9,1,'resc/jolas/ork.png',[Card.RegenStamina],'',[]],
            'Goblin': [1,200,200,350,3,1,'resc\jolas\Goblin.png',[Card.RegenStamina],'',[Card.draw_card_special]],
            'Fahnentraeger': [1,750,750,100,9,1,'resc\jolas\Fahnentraeger.png',[Card.RegenStamina],'',[Card.attack_booster_special]],
            'Drache': [1,500,7000,700,16,0,'resc\jolas\Bigboss.png',[Card.wake_up,Card.RegenStamina],'immovable',[]],
            'Bombe': [1,1,1,1000,3,5,'resc\jolas\Bombe.png',[],'wantstodie',[]],
            'Schild': [1,1000,2000,200,9,1,'resc\jolas\Schield.png',[Card.RegenStamina],'',[Card.shield_booster_special]],
            'Rammbock': [1,1500,1000,400,6,1,'resc\jolas\Rammbock.png',[Card.RegenStamina],'BW',[]],
            ...
            'Zwerg': [1,1000,1000,400,8,1,'resc\jolas\Zwerg.png',[Card.draw_card_special,Card.RegenStamina],'',[]],    
            'Elf':  [1,600,600,500,7,1,'resc\jolas\elf.png',[Card.generate_mana,Card.RegenStamina],'',[]],
